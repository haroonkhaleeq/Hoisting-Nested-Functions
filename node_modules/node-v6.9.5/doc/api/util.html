...
<head>
  <meta charset="utf-8">
  <title>util | Node.js v6.9.5 Documentation</title>
...
<li><a class="nav-util active" href="util.html">Utilities</a></li>
...
</div><p><em>Note: usage of <code>util.inherits()</code> is discouraged. Please use the ES6 <code>class</code> and
...
elements.</li>
<li><code>breakLength</code> <span class="type">&lt;number&gt;</span> The length at which an object&#39;s keys are split
...
</div><pre class="api_stability api_stability_0">Stability: 0 - Deprecated: Use <a href="console.html#console_console_error_data_args"><code>console.error()</code></a> instead.</pre><ul>
...
<span>Added in: v0.11.5</span>
<span>Deprecated since: v4.0.0 </span>
</div><pre class="api_stability api_stability_0">Stability: 0 - Deprecated: Use <a href="buffer.html#buffer_class_method_buffer_isbuffer_obj"><code>Buffer.isBuffer()</code></a> instead.</pre><ul>
<li><code>object</code> <span class="type">&lt;any&gt;</span></li>
</ul>
...
</div><pre class="api_stability api_stability_0">Stability: 0 - Deprecated: Use a third party module instead.</pre><ul>
...
<span>Added in: v0.3.0</span>
<span>Deprecated since: v0.11.3 </span>
</div><pre class="api_stability api_stability_0">Stability: 0 - Deprecated: Use <a href="console.html#console_console_log_data_args"><code>console.log()</code></a> instead.</pre><p>Deprecated predecessor of <code>console.log</code>.</p>
...
<span>Deprecated since: v6.0.0 </span>
</div><pre class="api_stability api_stability_0">Stability: 0 - Deprecated: Use <a href="https://developer.mozilla.org/en/docs/Web/JavaScript/Reference/Global_Objects/Object/assign"><code>Object.assign()</code></a> instead.</pre><p>The <code>util._extend()</code> method was never intended to be used outside of internal
