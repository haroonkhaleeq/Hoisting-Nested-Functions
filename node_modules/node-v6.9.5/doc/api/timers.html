...
<head>
  <meta charset="utf-8">
  <title>Timers | Node.js v6.9.5 Documentation</title>
...
<pre class="api_stability api_stability_3">Stability: 3 - Locked</pre><p>The <code>timer</code> module exposes a global API for scheduling functions to
...
built around <a href="https://github.com/nodejs/node/blob/master/doc/topics/event-loop-timers-and-nexttick.md">the Node.js Event Loop</a>.</p>
...
<a href="https://github.com/nodejs/node/blob/master/doc/topics/event-loop-timers-and-nexttick.md">the Node.js Event Loop</a></li>
...
<li><code>delay</code> <span class="type">&lt;number&gt;</span> The number of milliseconds to wait before calling the
