...
<head>
  <meta charset="utf-8">
  <title>Events | Node.js v6.9.5 Documentation</title>
...
</div><pre class="api_stability api_stability_0">Stability: 0 - Deprecated: Use <a href="#events_emitter_listenercount_eventname"><code>emitter.listenerCount()</code></a> instead.</pre><p>A class method that returns the number of listeners for the given <code>eventName</code>
...
</div><p>Returns an array listing the events for which the emitter has registered
