...
<head>
  <meta charset="utf-8">
  <title>Stream | Node.js v6.9.5 Documentation</title>
...
<li><span class="stability_undefined"><a href="#stream_organization_of_this_document">Organization of this Document</a></span></li>
<li><span class="stability_undefined"><a href="#stream_types_of_streams">Types of Streams</a></span><ul>
...
<li><span class="stability_undefined"><a href="#stream_writable_streams">Writable Streams</a></span><ul>
...
<li><span class="stability_undefined"><a href="#stream_readable_streams">Readable Streams</a></span><ul>
<li><span class="stability_undefined"><a href="#stream_two_modes">Two Modes</a></span></li>
<li><span class="stability_undefined"><a href="#stream_three_states">Three States</a></span></li>
<li><span class="stability_undefined"><a href="#stream_choose_one">Choose One</a></span></li>
...
<li><span class="stability_undefined"><a href="#stream_duplex_and_transform_streams">Duplex and Transform Streams</a></span><ul>
...
<div class="api_metadata">
<span>Added in: v0.9.4</span>
</div><p>The <code>&#39;close&#39;</code> event is emitted when the stream and any of its underlying
...
<div class="api_metadata">
<span>Added in: v0.9.4</span>
</div><p>If a call to <a href="#stream_writable_write_chunk_encoding_callback"><code>stream.write(chunk)</code></a> returns <code>false</code>, the
...
<div class="api_metadata">
<span>Added in: v0.9.4</span>
</div><p>The <code>&#39;finish&#39;</code> event is emitted after the <a href="#stream_writable_end_chunk_encoding_callback"><code>stream.end()</code></a> method
...
</div><p>The <code>writable.cork()</code> method forces all written data to be buffered in memory.
...
<div class="api_metadata">
<span>Added in: v0.9.4</span>
</div><p>The <code>&#39;end&#39;</code> event is emitted when there is no more data to be consumed from
the stream.</p>
