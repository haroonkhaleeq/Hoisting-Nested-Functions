...
<head>
  <meta charset="utf-8">
  <title>Buffer | Node.js v6.9.5 Documentation</title>
...
Use <a href="#buffer_class_method_buffer_from_string_encoding"><code>Buffer.from(string[, encoding])</code></a> instead.</pre><ul>
