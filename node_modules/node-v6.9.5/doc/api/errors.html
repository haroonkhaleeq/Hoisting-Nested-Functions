...
<head>
  <meta charset="utf-8">
  <title>Errors | Node.js v6.9.5 Documentation</title>
...
<p>Returns a number corresponding to the <strong>negated</strong> error code, which may be
referenced in <code>man 2 intro</code>. For example, an <code>ENOENT</code> error has an <code>errno</code> of
<code>-2</code> because the error code for <code>ENOENT</code> is <code>2</code>.</p>
