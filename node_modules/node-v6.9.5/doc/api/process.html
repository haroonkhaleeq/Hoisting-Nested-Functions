...
<head>
  <meta charset="utf-8">
  <title>process | Node.js v6.9.5 Documentation</title>
...
<li><span class="stability_undefined"><a href="#process_process_events">Process Events</a></span><ul>
<li><span class="stability_undefined"><a href="#process_event_beforeexit">Event: &#39;beforeExit&#39;</a></span></li>
<li><span class="stability_undefined"><a href="#process_event_disconnect">Event: &#39;disconnect&#39;</a></span></li>
...
<li><span class="stability_undefined"><a href="#process_event_warning">Event: &#39;warning&#39;</a></span><ul>
<li><span class="stability_undefined"><a href="#process_emitting_custom_warnings">Emitting custom warnings</a></span></li>
<li><span class="stability_undefined"><a href="#process_emitting_custom_deprecation_warnings">Emitting custom deprecation warnings</a></span></li>
</ul>
</li>
...
<li><span class="stability_undefined"><a href="#process_process_emitwarning_warning_name_ctor">process.emitWarning(warning[, name][, ctor])</a></span><ul>
...
<li><span class="stability_undefined"><a href="#process_tty_terminals_and_process_stdout">TTY Terminals and <code>process.stdout</code></a></span></li>
</ul>
</li>
...
<a href="#processexitcode-1"><code>process.exitCode</code></a> passed as the only argument.</p>
...
by the <a href="#processexitcode-1"><code>process.exitCode</code></a> property, or the <code>exitCode</code> argument passed to the
...
</div><p>The <code>&#39;uncaughtException&#39;</code> event is emitted when an uncaught JavaScript
...
refer to <a href="http://man7.org/linux/man-pages/man7/signal.7.html">signal(7)</a> for a listing of standard POSIX signal names such as
...
<li><code>SIGBUS</code>, <code>SIGFPE</code>, <code>SIGSEGV</code> and <code>SIGILL</code>, when not raised artificially
 using <a href="http://man7.org/linux/man-pages/man2/kill.2.html">kill(2)</a>, inherently leave the process in a state from which it is not
...
<p>The <code>process.arch</code> property returns a String identifying the processor
...
<p>The <code>process.config</code> property returns an Object containing the JavaScript
...
<li><code>code</code> <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Number_type" class="type">&lt;Integer&gt;</a> The exit code. Defaults to <code>0</code>.</li>
</ul>
...
<li><code>...args</code> <span class="type">&lt;any&gt;</span> Additional arguments to pass when invoking the <code>callback</code></li>
</ul>
...
<li><code>lts</code> <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type" class="type">&lt;String&gt;</a> a string label identifying the <a href="https://github.com/nodejs/LTS/">LTS</a> label for this release.
...
<div class="api_metadata">
<span>Added in: v0.1.28</span>
</div><p>The <code>process.setuid(id)</code> method sets the user identity of the process. (See
...
</div><p>The <code>process.stderr</code> property returns a <a href="stream.html">Writable</a> stream equivalent to or
...
<li>They never emit the <a href="stream.html#stream_event_finish"><code>&#39;finish&#39;</code></a> event.</li>
...
</div><p>The <code>process.stdin</code> property returns a <a href="stream.html">Readable</a> stream equivalent to or
...
<p>As a <a href="stream.html">Readable</a> stream, <code>process.stdin</code> can also be used in &quot;old&quot; mode that
...
</div><p>The <code>process.stdout</code> property returns a <a href="stream.html">Writable</a> stream equivalent to or
...
<p>To check if Node.js is being run in a <a href="tty.html#tty_tty">TTY</a> context, check the <code>isTTY</code>
...
Node.js and its dependencies. In addition, <code>process.versions.modules</code> indicates
the current ABI version, which is increased whenever a C++ API changes. Node.js
will refuse to load native modules built for an older <code>modules</code> value.</p>
