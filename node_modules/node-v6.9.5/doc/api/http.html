...
<head>
  <meta charset="utf-8">
  <title>HTTP | Node.js v6.9.5 Documentation</title>
...
<li><a class="nav-http-groups-google-com-group-nodejs" href="http://groups.google.com/group/nodejs">Mailing List</a></li>
    ...
    <div id="column1" data-id="http" class="interior">
      <header>
        <h1>Node.js v6.9.5 Documentation</h1>
        <div id="gtoc">
          <p>
...
<li><span class="stability_undefined"><a href="#http_event_checkexpectation">Event: &#39;checkExpectation&#39;</a></span></li>
...
<li><code>keepAliveMsecs</code> <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Number_type" class="type">&lt;Integer&gt;</a> When using HTTP KeepAlive, how often
...
<li><code>options</code> <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object" class="type">&lt;Object&gt;</a> A set of options providing information for name generation<ul>
<li><code>host</code> <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type" class="type">&lt;String&gt;</a> A domain name or IP address of the server to issue the request to</li>
...
entirely discarded.  However, if you add a <a href="#http_event_response"><code>&#39;response&#39;</code></a> event handler,
...
</div><p>Emitted when the request has been aborted by the client. This event is only
...
</div><p>Emitted when the request has been aborted by the server and the network
socket has closed.</p>
...
</div><p>Emitted when the server sends a &#39;100 Continue&#39; HTTP response, usually because
...
</div><p>Emitted when the server closes.</p>
...
<p>Emitted each time a client requests an HTTP <code>CONNECT</code> method. If this event isn&#39;t
...
<p>Emitted each time a client requests an HTTP upgrade. If this event isn&#39;t
...
<a href="net.html#net_event_listening"><code>&#39;listening&#39;</code></a> event. See also <a href="net.html#net_server_listen_handle_backlog_callback"><code>net.Server.listen()</code></a>.</p>
<p>Returns <code>server</code>.</p>
<p><em>Note</em>: The <code>server.listen()</code> method may be called multiple times. Each
...
<p>This function is asynchronous. <code>callback</code> will be added as a listener for the
<a href="net.html#net_event_listening"><code>&#39;listening&#39;</code></a> event.  See also <a href="net.html#net_server_listen_path_backlog_callback"><code>net.Server.listen(path)</code></a>.</p>
<p><em>Note</em>: The <code>server.listen()</code> method may be called multiple times. Each
subsequent call will <em>re-open</em> the server using the provided options.</p>
...
<p><code>backlog</code> is the maximum length of the queue of pending connections.
...
<p>This function is asynchronous. <code>callback</code> will be added as a listener for the
<a href="net.html#net_event_listening"><code>&#39;listening&#39;</code></a> event.  See also <a href="net.html#net_server_listen_port_hostname_backlog_callback"><code>net.Server.listen(port)</code></a>.</p>
<p><em>Note</em>: The <code>server.listen()</code> method may be called multiple times. Each
subsequent call will <em>re-open</em> the server using the provided options.</p>
...
</div><p>Indicates that the underlying connection was terminated before
...
<div class="api_metadata">
<span>Added in: v0.3.8</span>
</div><p>Emitted when the request has been aborted by the client and the network
socket has closed.</p>
<h3>Event: &#39;close&#39;<span><a class="mark" href="#http_event_close_2" id="http_event_close_2">#</a></span></h3>
<div class="api_metadata">
<span>Added in: v0.4.2</span>
</div><p>Indicates that the underlying connection was closed.
...
for reasons stated in <a href="#http_class_http_clientrequest"><code>http.ClientRequest</code></a> section.</p>
...
<li><code>protocol</code> <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type" class="type">&lt;String&gt;</a> Protocol to use. Defaults to <code>&#39;http:&#39;</code>.</li>
...
request to. Defaults to <code>&#39;localhost&#39;</code>.</li>
...
<li><code>family</code> <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Number_type" class="type">&lt;Number&gt;</a> IP address family to use when resolving <code>host</code> and
<code>hostname</code>. Valid values are <code>4</code> or <code>6</code>. When unspecified, both IP v4 and
v6 will be used.</li>
<li><code>port</code> <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Number_type" class="type">&lt;Number&gt;</a> Port of remote server. Defaults to 80.</li>
...
<li><code>socketPath</code> <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type" class="type">&lt;String&gt;</a> Unix Domain Socket (use one of host:port or
socketPath).</li>
<li><code>method</code> <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type" class="type">&lt;String&gt;</a> A string specifying the HTTP request method. Defaults to
<code>&#39;GET&#39;</code>.</li>
<li><code>path</code> <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type" class="type">&lt;String&gt;</a> Request path. Defaults to <code>&#39;/&#39;</code>. Should include query
string if any. E.G. <code>&#39;/index.html?page=12&#39;</code>. An exception is thrown when
the request path contains illegal characters. Currently, only spaces are
rejected but that may change in the future.</li>
...
<li><code>agent</code> <a href="http.html#http_class_http_agent" class="type">&lt;http.Agent&gt;</a> | <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Boolean_type" class="type">&lt;Boolean&gt;</a> Controls <a href="#http_class_http_agent"><code>Agent</code></a> behavior. When an Agent
is used request will default to <code>Connection: keep-alive</code>. Possible values:<ul>
...
details.</li>
<li><code>timeout</code> <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Number_type" class="type">&lt;Integer&gt;</a>: A number specifying the socket timeout in milliseconds.
