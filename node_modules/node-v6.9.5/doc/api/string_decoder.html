...
<head>
  <meta charset="utf-8">
  <title>StringDecoder | Node.js v6.9.5 Documentation</title>
...
<li><a class="nav-http-groups-google-com-group-nodejs" href="http://groups.google.com/group/nodejs">Mailing List</a></li>
    ...
    <div id="column1" data-id="string_decoder" class="interior">
      ...
      <div id="toc">
        ...
        <ul>
<li><span class="stability_2"><a href="#string_decoder_stringdecoder">StringDecoder</a></span><ul>
<li><span class="stability_undefined"><a href="#string_decoder_class_new_stringdecoder_encoding">Class: new StringDecoder([encoding])</a></span><ul>
