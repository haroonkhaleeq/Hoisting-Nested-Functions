...
<head>
  <meta charset="utf-8">
  <title>TLS (SSL) | Node.js v6.9.5 Documentation</title>
...
<li><a class="nav-tls active" href="tls.html">TLS/SSL</a></li>
...
<li><span class="stability_undefined"><a href="#tls_tls_ssl_concepts">TLS/SSL Concepts</a></span><ul>
...
<div class="api_metadata">
<span>Added in: v0.3.2</span>
</div><p>Returns the current number of concurrent connections on the server.</p>
...
<li><code>key</code> <span class="type">&lt;string&gt;</span> | <span class="type">&lt;string[]&gt;</span> | <a href="buffer.html#buffer_class_buffer" class="type">&lt;Buffer&gt;</a> | <span class="type">&lt;Buffer[]&gt;</span> A string, <code>Buffer</code>, array of
...
<a href="https://www.openssl.org/docs/man1.0.2/ssl/ssl.html#DEALING-WITH-PROTOCOL-METHODS">SSL_METHODS</a>.</li>
...
<p>Creates a new client connection to the given <code>options.port</code> and <code>options.host</code>
...
<p>Creates a new client connection to the given <code>port</code> and <code>host</code> or
...
<li><code>ciphers</code> <span class="type">&lt;string&gt;</span> A string describing the ciphers to use or exclude.
Consult
<a href="https://www.openssl.org/docs/man1.0.2/apps/ciphers.html#CIPHER-LIST-FORMAT">https://www.openssl.org/docs/man1.0.2/apps/ciphers.html#CIPHER-LIST-FORMAT</a>
...
server will time out. See <a href="https://www.openssl.org/docs/man1.0.2/ssl/SSL_CTX_set_timeout.html">SSL_CTX_set_timeout</a> for more details.</li>
...
</div><pre class="api_stability api_stability_0">Stability: 0 - Deprecated: Use <a href="#tls_class_tls_tlssocket"><code>tls.TLSSocket</code></a> instead.</pre><p>The <code>tls.CryptoStream</code> class represents a stream of encrypted data. This class
...
<span>Added in: v0.3.2</span>
<span>Deprecated since: v0.11.3 </span>
</div><pre class="api_stability api_stability_0">Stability: 0 - Deprecated: Use <a href="#tls_class_tls_tlssocket"><code>tls.TLSSocket</code></a> instead.</pre><p>Returned by <a href="#tls_tls_createsecurepair_context_isserver_requestcert_rejectunauthorized_options"><code>tls.createSecurePair()</code></a>.</p>
...
<span>Added in: v0.3.2</span>
<span>Deprecated since: v0.11.3 </span>
</div><pre class="api_stability api_stability_0">Stability: 0 - Deprecated: Use <a href="#tls_class_tls_tlssocket"><code>tls.TLSSocket</code></a> instead.</pre><ul>
